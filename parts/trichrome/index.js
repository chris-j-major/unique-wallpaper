...
module.exports = {
  ...
  create:function create(struct,stack){
    return new Trichrome(struct,stack);
  }
}

function Trichrome( struct , stack ){
  ...
  for ( var n = 0 ; n < 20 ; n++){
    ...
    this.addRange( weight , new Color( hue + (1/3) , sat , lightness ));
    this.addRange( weight , new Color( hue + (2/3) , sat , lightness ));
  }
}

Pallete.extend(Trichrome)
